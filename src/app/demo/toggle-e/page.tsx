...
export default function ToggleEPage() {
    ...
    <div className="min-h-screen py-12">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold">Toggle E: Text-only</h1>
          <p className="text-gray-400 mt-2">No icons, no borders • ~65% smaller</p>
        ...
        <div className="mx-auto max-w-md">
          <div className="rounded-2xl border border-gray-800 bg-gray-900 p-6">
            ...
            <div className="mb-4 flex items-center justify-between">
              ...
              {/* TOGGLE E: Text-only mini toggle */}
              <div className="flex items-center text-sm">
                <button
                  onClick={() => setMode('preview')}
                  className={`px-2 py-1 transition-colors ${
                    mode === 'preview' ? 'text-amber-400 font-medium' : 'text-gray-500 hover:text-gray-300'
                  }`}
                >
                  Preview
                </button>
                ...
                <button
                  ...
                  className={`px-2 py-1 transition-colors ${
                    mode === 'execute' ? 'text-green-400 font-medium' : 'text-gray-500 hover:text-gray-300'
                  }`}
                >
                  Execute
                </button>
        ...
        <div className="mt-12 mx-auto max-w-2xl">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-purple-500/30 bg-purple-500/5 p-4">
              <p className="text-xs text-purple-400 mb-2">Option E (compact)</p>
              <div className="flex items-center text-sm">
                <span className={mode === 'preview' ? 'text-amber-400 font-medium' : 'text-gray-500'}>Preview</span>
                <span className="text-gray-600 mx-1">|</span>
                <span className={mode === 'execute' ? 'text-green-400 font-medium' : 'text-gray-500'}>Execute</span>
              </div>
            </div>
          </div>
        </div>
