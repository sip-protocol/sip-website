...
export default function ToggleAPage() {
    ...
    <div className="min-h-screen py-12">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold">Toggle A: Icon-only</h1>
          <p className="text-gray-400 mt-2">Icons only with tooltips on hover • ~60% smaller</p>
        ...
        <div className="mx-auto max-w-md">
          <div className="rounded-2xl border border-gray-800 bg-gray-900 p-6">
            ...
            <div className="mb-4 flex items-center justify-between">
              ...
              {/* TOGGLE A: Icon-only with tooltips */}
              <div className="inline-flex rounded-lg border border-gray-700 bg-gray-800 p-0.5">
                ...
                >
                  ...
                  <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded bg-gray-900 px-2 py-1 text-xs opacity-0 transition-opacity group-hover:opacity-100 border border-gray-700">
                    Preview
                  </span>
                </button>
                <button
        ...
        <div className="mt-12 mx-auto max-w-2xl">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-purple-500/30 bg-purple-500/5 p-4">
              <p className="text-xs text-purple-400 mb-2">Option A (compact)</p>
              <div className="inline-flex rounded-lg border border-gray-700 bg-gray-800 p-0.5">
                <button className={`rounded-md p-2 ${mode === 'preview' ? 'bg-amber-600 text-white' : 'text-gray-400'}`}>
                  <EyeIcon className="h-4 w-4" />
                </button>
                <button className={`rounded-md p-2 ${mode === 'execute' ? 'bg-green-600 text-white' : 'text-gray-400'}`}>
                  <BoltIcon className="h-4 w-4" />
                </button>
              </div>
            </div>
